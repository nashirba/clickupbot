...
#     cliend_id = CLICKUP_CLIENT_ID # ClickupUser.objects.filter('Нурлан').reg_client_id
#     url = f'https://app.clickup.com/api?client_id={cliend_id}&redirect_uri={REDIRECT_URI}'
#     keyboard = [InlineKeyboardButton("get code", url=url]
